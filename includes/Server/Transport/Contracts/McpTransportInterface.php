...
namespace WpMcpUltimate\Server\Transport\Contracts;
...
interface McpTransportInterface {
	 ...
	 *
	 * @param \WpMcpUltimate\Server\Transport\Infrastructure\McpTransportContext $context Dependency injection container.
	 */
