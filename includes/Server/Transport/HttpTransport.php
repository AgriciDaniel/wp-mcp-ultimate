...
namespace WpMcpUltimate\Server\Transport;

use WpMcpUltimate\Server\Transport\Contracts\McpRestTransportInterface;
use WpMcpUltimate\Server\Transport\Infrastructure\HttpRequestContext;
use WpMcpUltimate\Server\Transport\Infrastructure\HttpRequestHandler;
use WpMcpUltimate\Server\Transport\Infrastructure\McpTransportContext;
use WpMcpUltimate\Server\Transport\Infrastructure\McpTransportHelperTrait;
...
class HttpTransport implements McpRestTransportInterface {
	 ...
	 *
	 * @var \WpMcpUltimate\Server\Transport\Infrastructure\HttpRequestHandler
	 */
	 ...
	 *
	 * @param \WpMcpUltimate\Server\Transport\Infrastructure\McpTransportContext $transport_context The transport context.
	 */
