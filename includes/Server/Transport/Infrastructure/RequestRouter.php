...
use WpMcpUltimate\Server\Infrastructure\ErrorHandling\McpErrorFactory;
...
class RequestRouter {
	 ...
	 *
	 * @var \WpMcpUltimate\Server\Transport\Infrastructure\McpTransportContext
	 */
	 ...
	 *
	 * @param \WpMcpUltimate\Server\Transport\Infrastructure\McpTransportContext $context The transport context.
	 */
	 ...
	 * @param \WpMcpUltimate\Server\Transport\Infrastructure\HttpRequestContext|null $http_context HTTP context for session management.
	 *
	 * @return array
	 */
