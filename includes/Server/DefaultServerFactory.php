...
use WpMcpUltimate\Server\Infrastructure\ErrorHandling\ErrorLogMcpErrorHandler;
use WpMcpUltimate\Server\Infrastructure\Observability\NullMcpObservabilityHandler;
use WpMcpUltimate\Server\Transport\HttpTransport;
...
class DefaultServerFactory {
	...
	public static function create(): void {
		...
		$wordpress_defaults = array(
			'server_id'              => 'wp-mcp-ultimate-server',
			...
			'tools'                  => array(
				'wp-mcp-ultimate/discover-abilities',
				'wp-mcp-ultimate/get-ability-info',
				'wp-mcp-ultimate/execute-ability',
			),
