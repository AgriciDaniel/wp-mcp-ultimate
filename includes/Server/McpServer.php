...
use WpMcpUltimate\Server\Domain\Prompts\McpPrompt;
use WpMcpUltimate\Server\Domain\Resources\McpResource;
use WpMcpUltimate\Server\Domain\Tools\McpTool;
...
use WpMcpUltimate\Server\Transport\Infrastructure\McpTransportContext;
...
class McpServer {
	 ...
	 *
	 * @var \WpMcpUltimate\Server\McpComponentRegistry
	 */
	 ...
	 *
	 * @var \WpMcpUltimate\Server\McpTransportFactory
	 */
	 ...
	 * @param class-string<\WpMcpUltimate\Server\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface>|null         $error_handler Error handler class to use (e.g., NullMcpErrorHandler::class). Must implement McpErrorHandlerInterface. If null, NullMcpErrorHandler will be used.
	 * @param class-string<\WpMcpUltimate\Server\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface>|null $observability_handler Observability handler class to use (e.g., NullMcpObservabilityHandler::class). Must implement McpObservabilityHandlerInterface. If null, NullMcpObservabilityHandler will be used.
	...
	private function setup_handlers( ?string $error_handler, ?string $observability_handler ): void {
		...
		if ( $error_handler && class_exists( $error_handler ) ) {
			/** @var \WpMcpUltimate\Server\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface $handler */
		...
		if ( $observability_handler && class_exists( $observability_handler ) ) {
			/** @var \WpMcpUltimate\Server\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface $handler */
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface
	 */
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Domain\Resources\McpResource[]
	 */
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Domain\Tools\McpTool|null
	 */
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Domain\Resources\McpResource|null
	 */
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Domain\Prompts\McpPrompt|null
	 */
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Transport\Infrastructure\McpTransportContext
	 */
	 ...
	 *
	 * @return \WpMcpUltimate\Server\McpComponentRegistry
	 */
