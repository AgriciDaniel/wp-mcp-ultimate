...
class RegisterAbilityAsMcpPrompt {
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Domain\Prompts\McpPrompt|\WP_Error Returns prompt instance or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Domain\Prompts\McpPrompt|\WP_Error MCP prompt instance or WP_Error if validation fails.
	 */
