...
abstract class McpPromptBuilder implements McpPromptBuilderInterface {
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Domain\Prompts\McpPrompt The built prompt.
		...
		$prompt  = new class(
			...
			public function get_ability(): \WP_Error {
				...
				return new \WP_Error(
					...
					esc_html__( 'Builder-based prompts do not have an associated ability.', 'wp-mcp-ultimate' )
				);
			}
		};
