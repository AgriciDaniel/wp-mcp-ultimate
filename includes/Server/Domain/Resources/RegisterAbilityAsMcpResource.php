...
use WpMcpUltimate\Server\Domain\Utils\McpAnnotationMapper;
use WP_Ability;
 ...
 * array(
 *     'uri' => 'WordPress://wp-mcp-ultimate/my-resource',
 *     'mimeType' => 'text/plain',
 *     'annotations' => array(...)
 * )
 */
class RegisterAbilityAsMcpResource {
	 ...
	 * @param \WpMcpUltimate\Server\Core\McpServer $mcp_server The MCP server.
	 *
	 * @return \WpMcpUltimate\Server\Domain\Resources\McpResource|\WP_Error Returns resource instance or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Domain\Resources\McpResource|\WP_Error Returns the MCP resource instance or WP_Error if validation fails.
	 */
