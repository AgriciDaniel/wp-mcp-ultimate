...
use WpMcpUltimate\Server\Domain\Utils\SchemaTransformer;
use WP_Ability;
...
class RegisterAbilityAsMcpTool {
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Domain\Tools\McpTool|\WP_Error Returns a new instance of McpTool or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \WpMcpUltimate\Server\Domain\Tools\McpTool|\WP_Error The validated MCP tool instance or WP_Error if validation fails.
	 */
