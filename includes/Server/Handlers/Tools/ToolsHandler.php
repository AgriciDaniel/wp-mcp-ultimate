...
namespace WpMcpUltimate\Server\Handlers\Tools;

use WpMcpUltimate\Server\McpServer;
use WpMcpUltimate\Server\Domain\Tools\McpTool;
use WpMcpUltimate\Server\Handlers\HandlerHelperTrait;
...
class ToolsHandler {
	 ...
	 * Constructor.
	 *
	 * @param \WpMcpUltimate\Server\Core\McpServer $mcp The WordPress MCP instance.
	 */
	 ...
	 *
	 * @param \WpMcpUltimate\Server\Domain\Tools\McpTool $tool Raw tool data.
	 *
